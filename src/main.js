...
export default {
    // 这个字段走 app.json
    config: {
        pages: ['^pages/index/index', 'pages/club/club', 'pages/message/message', 'pages/mine/mine', 'pages/details/details', 'pages/personal/personal', 'pages/activity/activity', 'pages/comments/comments', 'pages/events/events', 'pages/clubEdit/clubEdit'], // 页面前带有 ^ 符号的，会被编译成首页，其他页面可以选填，我们会自动把 webpack entry 里面的入口页面加进去
        window: {
